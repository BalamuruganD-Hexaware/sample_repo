...
using ElmahCore.Mvc;
using ElmahCore;
using managementservice.Api.Filters;
using managementservice.Business.Installer;

namespace managementservice.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "managementservice API", Version = version + "-" + branch});
            });
