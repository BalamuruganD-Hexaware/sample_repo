...
using ElmahCore.Mvc;
using ElmahCore;
using onboardingservice.Api.Filters;
using onboardingservice.Business.Installer;

namespace onboardingservice.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "onboardingservice API", Version = version + "-" + branch});
            });
