...
using ElmahCore.Mvc;
using ElmahCore;
using hhhhhh.Api.Filters;
using hhhhhh.Business.Installer;

namespace hhhhhh.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "hhhhhh API", Version = version + "-" + branch});
            });
