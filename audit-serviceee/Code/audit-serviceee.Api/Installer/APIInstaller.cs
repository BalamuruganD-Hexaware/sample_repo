...
using ElmahCore.Mvc;
using ElmahCore;
using audit-serviceee.Api.Filters;
using audit-serviceee.Business.Installer;

namespace audit-serviceee.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "audit-serviceee API", Version = version + "-" + branch});
            });
