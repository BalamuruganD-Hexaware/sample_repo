...
using ElmahCore.Mvc;
using ElmahCore;
using temp-manage-service.Api.Filters;
using temp-manage-service.Business.Installer;

namespace temp-manage-service.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "temp-manage-service API", Version = version + "-" + branch});
            });
