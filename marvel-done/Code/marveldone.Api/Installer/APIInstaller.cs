...
using ElmahCore.Mvc;
using ElmahCore;
using marveldone.Api.Filters;
using marveldone.Business.Installer;

namespace marveldone.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "marveldone API", Version = version + "-" + branch});
            });
