...
using ElmahCore.Mvc;
using ElmahCore;
using onboard-service.Api.Filters;
using onboard-service.Business.Installer;

namespace onboard-service.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "onboard-service API", Version = version + "-" + branch});
            });
