...
using ElmahCore.Mvc;
using ElmahCore;
using web-jj.Api.Filters;
using web-jj.Business.Installer;

namespace web-jj.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "web-jj API", Version = version + "-" + branch});
            });
