...
using ElmahCore.Mvc;
using ElmahCore;
using manageeeeservice.Api.Filters;
using manageeeeservice.Business.Installer;

namespace manageeeeservice.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "manageeeeservice API", Version = version + "-" + branch});
            });
