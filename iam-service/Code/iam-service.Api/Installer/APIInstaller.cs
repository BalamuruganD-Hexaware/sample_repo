...
using ElmahCore.Mvc;
using ElmahCore;
using iam-service.Api.Filters;
using iam-service.Business.Installer;

namespace iam-service.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "iam-service API", Version = version + "-" + branch});
            });
