...
using ElmahCore.Mvc;
using ElmahCore;
using app_designer_service.Api.Filters;
using app_designer_service.Business.Installer;

namespace app_designer_service.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "app_designer_service API", Version = version + "-" + branch});
            });
