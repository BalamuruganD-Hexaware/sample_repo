...
using ElmahCore.Mvc;
using ElmahCore;
using audit-service.Api.Filters;
using audit-service.Business.Installer;

namespace audit-service.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "audit-service API", Version = version + "-" + branch});
            });
